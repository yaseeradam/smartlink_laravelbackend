...
class _ReturnsScreenState extends State<ReturnsScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final res = await ApiClient.instance.getJson('returns');
      ...
      body: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            if (!_loading && _error == null && _items.isEmpty) _EmptyCard(isDark: isDark, message: 'No returns yet.'),
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.assignment_return, color: AppTheme.primaryColor),
                        ),
...
class _EmptyCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.assignment_return_outlined, color: isDark ? Colors.white54 : Colors.black45),
