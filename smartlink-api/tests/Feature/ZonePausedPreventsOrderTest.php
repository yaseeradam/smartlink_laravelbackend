...
class ZonePausedPreventsOrderTest extends TestCase
{
    use RefreshDatabase;

    public function test_order_blocked_when_zone_paused(): void
    {
        $zone = Zone::create([
            'name' => 'Paused Zone',
            'city' => 'Test City',
        ...
        $seller = User::create([
            'full_name' => 'Seller',
            'phone' => '08099990012',
            'email' => 'seller-paused@test.local',
            'password' => 'password',
